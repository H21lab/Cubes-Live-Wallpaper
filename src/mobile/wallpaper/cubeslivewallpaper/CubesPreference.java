/*
 * Number of cubes - preferences class
 *
...
public class CubesPreference extends Preference implements OnSeekBarChangeListener {
	...
	public CubesPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected void onSetInitialValue(boolean restoreValue, Object defaultValue) {
		...
		int temp = restoreValue ? getPersistedInt(5) : (Integer) defaultValue;
