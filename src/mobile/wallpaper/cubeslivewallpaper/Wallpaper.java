...
public class Wallpaper extends GLWallpaperService {
	private static String TAG = "Wallpaper";
    ...
    SensorEventListener mGravityListener = new SensorEventListener() {
        public void onSensorChanged(SensorEvent event) {
        	...
        	Game.Gt.x = -event.values[0];
           	Game.Gt.y = -event.values[1];
           	Game.Gt.z = -event.values[2];
           	
           	//Log.d("Test", Game.Gt.x + " " + Game.Gt.y + " " + Game.Gt.z);
        }
    ...
    SensorEventListener mAccListener = new SensorEventListener() {
        public void onSensorChanged(SensorEvent event) {
            ...
            // compute current tilt
        	Game.At.x = -event.values[0];
           	Game.At.y = -event.values[1];
           	Game.At.z = -event.values[2];
